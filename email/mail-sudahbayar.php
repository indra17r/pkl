...
$mail->Subject = "muslimModern.com berhasil memverifikasi pembayaran pesanan anda dengan kode pesan ".$kode_pesan."";
$mail->Body = "<body style='margin: 10px;'>
 ...
 <br>
 <h2>Pembayaran pesanan anda dengan kode pesan ".$kode_pesan." telah kami verifikasi dan pemesanan sedang kami proses</h2><br>
 ...
 <p>Kami akan kembali memberikan notifikasi kepada Anda jika pesanan anda telah kami kirim.</p>
