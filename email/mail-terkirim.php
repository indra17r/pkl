...
$mail->Subject = "Pesanan anda dengan kode pesan ".$kode_pesan." telah dikirim oleh musliModern.com";
$mail->Body = "<body style='margin: 10px;'>
 ...
 <br>
 <h2>Pesanan anda dengan kode pesan ".$kode_pesan." telah kami kirim</h2><br>
 <p>Anda dapat melakukan track resi berikut <b>".$row1['resi_pesan']."</b> melalui cekresi.com</a></p>
 <p align='center'><a href='http://cekresi.com/?noresi=".$row1['resi_pesan']."'>Track Resi</a></p>
 ...
 <p>Kami akan kembali memberikan notifikasi kepada Anda jika Anda telah menerima pesanan Anda.</p>
 ...
 <b>Total Terbayar :</b> Rp ".number_format($grand, 0, '', '.').",-<br>
